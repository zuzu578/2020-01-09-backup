...
<ul class="informations-items">
	...
	<li>욕설 및 비방 글을 금지합니다.</li>
     ...
     <form action="DoUpdateAdmin" method="GET">
    <table class="table table-striped">
    <!-- readonly 는 읽을 수만있음 수정 x -->
   		 
    	<tr><td algin=right>작성일</td> <td>${Adto.rdate }</td></tr>
    	<tr><td algin=right>조회수</td> <td>${Adto.nClick}</td></tr>
   		<tr><td algin=right>게시물번호</td> <td><input type="text" name="board_num"value='${Adto.board_num }' readonly></td></tr>
    	<tr><td algin=right>제목</td> <td><input type="text" id="boardtopic"  name="boardtopic"value='${Adto.boardtopic }'class="form-control" placeholder="" aria-label="Username" aria-describedby="basic-addon1"></td></tr>
    	<tr><td algin=right>작성자</td> <td><div class="input-group mb-3">
  			<input type="hidden" value="hidden" name="hidden" readonly>
  <input type="text"  id="userid" name="userid"value='${Adto.userid }'class="form-control" placeholder="" aria-label="Username" aria-describedby="basic-addon1">
</div></td></tr>
    	<tr><td algin=right>내용</td><td><div class="input-group">
 
  <textarea class="form-control" id="board_comment" name="board_comment" aria-label="With textarea">${Adto.board_comment }</textarea>
</div></td></tr>
