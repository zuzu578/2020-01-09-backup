...
<h1 class="informations">Admin 님! 공지 글을 올리기전에 읽어주세요!</h1>
	<div class="admin-please">
		 <p class="please">건전한 커뮤니티를 위해 권력남용을 금지해주세요!</p>
	 <p class="please">건전한 커뮤니티를 위해 Admin님이 힘을 써주세요!</p>
		
</div>

</div>
<form method="POST" action="WriteAdminNotice">
  ...
  <input type="text" class="form-control" id="userid" value="admin"  name="userid" placeholder="" readonly aria-label="Username" aria-describedby="basic-addon1">
</div></td></tr>
