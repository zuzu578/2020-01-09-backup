...
<p class="userid">${userid }<a href="http://localhost:8080/project/userinfomation?userid=${userid}"><i class="fab fa-facebook-messenger"></i></a></p><div class="form-check form-switch">
  <input class="form-check-input" type="checkbox" id="flexSwitchCheckChecked" checked>
  <label class="form-check-label" for="flexSwitchCheckChecked">즐겨찾기</label>
</div>
<p class="bulletin-number">총 게시글: ${DmCount }개 </p>
<p class="ranking"> 래더 랭킹   위(상위 %)  </p>
<p class="date">이 유저의 최근 활동시간:${date } </p>
...
<div class="input-group mb-3">
  ...
  <input type="text" class="form-control" placeholder="받는사람" value="${userid}"  name="userid" aria-label="Username" aria-describedby="basic-addon1">
</div>
